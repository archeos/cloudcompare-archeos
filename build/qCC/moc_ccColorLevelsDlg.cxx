...
static const char qt_meta_stringdata_ccColorLevelsDlg[] = {
    "ccColorLevelsDlg\0\0onChannelChanged(int)\0"
    "onApply()\0"
};
...
const QMetaObjectExtraData ccColorLevelsDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccColorLevelsDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccColorLevelsDlg,
      qt_meta_data_ccColorLevelsDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccColorLevelsDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccColorLevelsDlg))
