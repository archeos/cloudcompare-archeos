...
static const char qt_meta_stringdata_ccPointPickingGenericInterface[] = {
    "ccPointPickingGenericInterface\0\0"
    "cloudID,pointIdx,x,y\0"
    "handlePickedPoint(int,uint,int,int)\0"
};
...
void ccPointPickingGenericInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->handlePickedPoint((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ccPointPickingGenericInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccPointPickingGenericInterface::staticMetaObject = {
    { &ccOverlayDialog::staticMetaObject, qt_meta_stringdata_ccPointPickingGenericInterface,
      qt_meta_data_ccPointPickingGenericInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccPointPickingGenericInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccPointPickingGenericInterface))
