...
static const char qt_meta_stringdata_ccOrthoSectionGenerationDlg[] = {
    "ccOrthoSectionGenerationDlg\0\0"
    "onStepChanged(double)\0"
};
...
const QMetaObjectExtraData ccOrthoSectionGenerationDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccOrthoSectionGenerationDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccOrthoSectionGenerationDlg,
      qt_meta_data_ccOrthoSectionGenerationDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccOrthoSectionGenerationDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccOrthoSectionGenerationDlg))
