...
public:
    ...
    void setupUi(QDialog *GraphicalTransformationDlg)
    {
        ...
        GraphicalTransformationDlg->resize(116, 90);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/CC/Comp/images/comp/validate.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/CC/Comp/images/comp/cancel.png"), QSize(), QIcon::Normal, QIcon::Off);
