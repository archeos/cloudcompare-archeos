...
static const char qt_meta_stringdata_ccOrderChoiceDlg[] = {
    "ccOrderChoiceDlg\0\0swap()\0"
};
...
const QMetaObjectExtraData ccOrderChoiceDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccOrderChoiceDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccOrderChoiceDlg,
      qt_meta_data_ccOrderChoiceDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccOrderChoiceDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccOrderChoiceDlg))
        return static_cast<void*>(const_cast< ccOrderChoiceDlg*>(this));
    if (!strcmp(_clname, "Ui::RoleChoiceDialog"))
        return static_cast< Ui::RoleChoiceDialog*>(const_cast< ccOrderChoiceDlg*>(this));
