...
static const char qt_meta_stringdata_ccColorScaleSelector[] = {
    "ccColorScaleSelector\0\0colorScaleSelected(int)\0"
    "colorScaleEditorSummoned()\0"
};
...
const QMetaObjectExtraData ccColorScaleSelector::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccColorScaleSelector::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ccColorScaleSelector,
      qt_meta_data_ccColorScaleSelector, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccColorScaleSelector::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccColorScaleSelector))
