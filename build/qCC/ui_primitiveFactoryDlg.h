...
public:
    ...
    void setupUi(QDialog *PrimitiveFactoryDlg)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/plane.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/box.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/sphere.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/cylinder.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/cone.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/torus.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/CC/Primitives/images/primitives/dish.gif"), QSize(), QIcon::Normal, QIcon::Off);
