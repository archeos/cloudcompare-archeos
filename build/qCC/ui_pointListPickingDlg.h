...
public:
    ...
    void retranslateUi(QDialog *PointListPickingDlg)
    {
        ...
        label_3->setText(QApplication::translate("PointListPickingDlg", "start index", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        showGlobalCoordsCheckBox->setToolTip(QApplication::translate("PointListPickingDlg", "Show global coordinates (instead of shifted ones)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        showGlobalCoordsCheckBox->setText(QApplication::translate("PointListPickingDlg", "show global coordinates", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
