...
static const char qt_meta_stringdata_ccSelectChildrenDlg[] = {
    "ccSelectChildrenDlg\0\0onAccept()\0"
};
...
const QMetaObjectExtraData ccSelectChildrenDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ccSelectChildrenDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccSelectChildrenDlg,
      qt_meta_data_ccSelectChildrenDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ccSelectChildrenDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ccSelectChildrenDlg))
